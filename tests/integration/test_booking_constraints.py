...
from bookings.models import Booking, Accommodation, Booker
...
class TestBookingOverlapConstraint:
    def test_cannot_create_overlapping_bookings(self):
        ...
        booker = Booker.objects.create(name="Test Booker", group_size=4, email="test@example.com", phone="1234567890")
