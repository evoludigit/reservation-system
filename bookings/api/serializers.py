...
class BookingSerializer(serializers.ModelSerializer):
    ...
    accommodation_capacity = serializers.IntegerField(
        source="accommodation.capacity", read_only=True
    )
...
class BookingCreateSerializer(serializers.Serializer):
    ...
    accommodation_id = serializers.PrimaryKeyRelatedField(
        queryset=Accommodation.objects.filter(is_active=True), source="accommodation"
    )
    booker_id = serializers.PrimaryKeyRelatedField(queryset=Booker.objects.all(), source="booker")
